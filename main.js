...
/* harmony default export */ var quiz = ({
  init: function init() {
    ...
    var question = document.querySelector('.question__question');
    var questionList = document.querySelector('.question__list');
    var questionImg = document.querySelector('.question__img');
    var progressInfo = document.querySelector('.question__top-info span');
    var step = 0;
    var progressBar = document.querySelector('.question__top-progress');
    var progressShow = document.querySelector('.question__top-progress-show');
    function showQ(questionNumber) {
      question.innerHTML = questions[step].q;
      var options = '';
      questionImg.innerHTML = " <img src=\"".concat(questions[step]['img'], "\" alt=\"").concat(questions[step]['img'], "\">");
      for (var key in questions[step]['opt']) {
        options += "  \n        <div class=\"checkbox-wrap\">\n          <div class=\"question__checkbox\">\n            <input id=\"".concat(key, "\" class=\"checkbox\" name='").concat(step, "'  type=\"radio\" checked>\n            <label for=\"").concat(key, "\">\n              ").concat(questions[step]['opt'][key], "\n            </label>\n          </div>\n        </div>");
      }
      questionList.innerHTML = options;
    }
    var progressLine = progressShow.offsetWidth;
    btnNext.addEventListener('click', function () {
      ...
      var progressBarP = progressBar.offsetWidth;
      var progressReady = progressBarP / questions.length;
      progressLine += progressReady;
      progressShow.style.width = "".concat(progressLine, "px");
